...
# Create a new recipe for tree-based models
...
```{r}
# Extract the fitted workflow from final_fit
...
# Extract the fitted parsnip model from rf_fit
rf_parsnip_model <- extract_fit_parsnip(rf_fit)

# Access the underlying ranger model
rf_ranger_model <- rf_parsnip_model$fit

# Check the class to ensure it's a ranger object
class(rf_ranger_model)
# Should output: [1] "ranger"
